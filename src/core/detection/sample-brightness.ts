import type { BrightnessGrid, GrayscaleData } from "../types.ts"

export const sampleBrightness = (params: { grayscaleData: GrayscaleData; cellSize: number }): BrightnessGrid => {
...
const calculateBrightnessValues = (params: { grayscaleData: GrayscaleData; cellSize: number; cols: number; rows: number }): number[][] => {
...
const calculateCellBrightness = (params: { grayscaleData: GrayscaleData; cellSize: number; row: number; col: number }): number => {
