...
const tracePolyline = (params: { x: number; y: number; width: number; height: number; edges: Uint8Array; visited: Uint8Array }): Polyline => {
...
const findNextEdgePixel = (params: { x: number; y: number; width: number; height: number; edges: Uint8Array; visited: Uint8Array }): Point | null => {
  const { x, y, width, height, edges, visited } = params
...
const extendPolylineBackward = (params: { polyline: Polyline; width: number; height: number; edges: Uint8Array; visited: Uint8Array }): Polyline => {
