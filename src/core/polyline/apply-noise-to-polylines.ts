import { generatePerlinNoise } from "../hatching/generate-perlin-noise.ts"
...
const applyNoiseToPolyline = (params: { polyline: Polyline; noiseAmount: number; noiseScale: number }): Polyline => {
...
const displacePoint = (params: { point: Point; index: number; polyline: Polyline; noiseAmount: number; noiseScale: number }): Point => {
...
const calculatePerpendicular = (params: { point: Point; index: number; polyline: Polyline }): Point => {
