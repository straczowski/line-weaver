...
export const mergeConnectedPolylines = (params: { polylines: Polyline[]; tolerance?: number }): Polyline[] => {
...
const arePointsClose = (a: Point, b: Point, tolerance: number): boolean => Math.abs(a.x - b.x) < tolerance && Math.abs(a.y - b.y) < tolerance
