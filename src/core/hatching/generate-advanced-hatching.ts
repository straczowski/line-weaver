...
const generateCellHatchLines = (params: { row: number; col: number; cellSize: number; angle: number; lineCount: number }): Polyline[] => {
...
const clipLineToCell = (params: { start: Point; end: Point; cellX: number; cellY: number; cellSize: number }): Polyline | null => {
...
const cohenSutherlandClip = (params: { x1: number; y1: number; x2: number; y2: number; minX: number; maxX: number; minY: number; maxY: number }): { x1: number; y1: number; x2: number; y2: number } | null => {
